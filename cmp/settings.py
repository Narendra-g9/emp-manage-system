...
SECRET_KEY = os.environ.get(
    'SECRET_KEY',
    'django-insecure-wb*if-vwv*%$ptw38y-6osa^b*s5sg)hltrimpo^3qo5^**1)a'
)
...
MIDDLEWARE = [
    ...
    # Commented out CSRF middleware for API testing
...
# In production, DATABASE_URL env var is used. Locally, falls back to local MySQL.
...
# DRF: default filter backends and authentication
REST_FRAMEWORK = {
